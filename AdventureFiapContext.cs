...
public partial class AdventureFiapContext : DbContext
{
    public AdventureFiapContext()
    {
    }

    public AdventureFiapContext(DbContextOptions<AdventureFiapContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Name=ConnectionStrings:AdventureFiap");
